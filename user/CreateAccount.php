...
<body>
    ...
    <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="tab mb-3">
            ...
            <p class="login-card-footer-text">Already have an account? <a href="../user/login.php" class="text-reset">Login</a></p>
        ...
        <div class="tab mb-3" id="KycTab">
            ...
            <div class="form-group mb-3">
                <label for="exampleFormControlFile1">PAN Card (Upload only jpeg/jpg documents)</label>
            ...
            <div class="form-groupmb-3">
                <label for="exampleFormControlFile1">Aadhar Card (Upload only jpeg/jpg documents)</label>
