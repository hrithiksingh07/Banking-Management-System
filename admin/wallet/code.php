...
// WithdrawMoney / Checking Balance
...
if (isset($_POST['WithdrawAc'])) {
    $AccountNo = $_POST['WithdrawAc'];
        ...
        if (mysqli_num_rows($Result) > 0) {
            ...
            if ($Status == "Active") {
                ...
                try {
                    ...
                    mysqli_query($conn, "UPDATE accounts SET Balance='$total' WHERE AccountNo = '$AccountNo'") or die(mysqli_error($conn));
                    mysqli_query($conn, "INSERT INTO transaction(AccountNo, FAccountNo, Name, Amount,Status, ProfileColor, Credit, Debit) VALUES ('$AccountNo', 'NA','$SenderName', '$Amount','Debited', 'blue', '0.0', '$Amount')") or die(mysqli_error($conn));
                    mysqli_commit($conn);
