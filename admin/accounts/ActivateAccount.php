                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                if (isset($_POST['SActivate_btn'])) {
                                    $DAccountNo = $_SESSION['SActivate_id'];
                                    $Dquery = "UPDATE login SET Status = 'Active' WHERE AccountNo = '$DAccountNo'";
                                    $result = mysqli_query($conn, $Dquery) or die('Query Fail');
                                    if ($result) {
                                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="light">
                                                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                                                <input type="hidden" name="Activate_id" id="Activate_id" value="<?php echo $row['AccountNo']; ?>">
                                                                                <button name="Activate_btn" id="Activate_btn" type="submit" data-toggle="modal" data-target="#Verify" class="btn btn-success"><i class='bx bx-power-off bx-flip-horizontal'></i>Activate</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="light">
                                                                    ...
                                                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                                                        ...
                                                                        <input id="SActivate_id" type="hidden" name="SActivate_id" value="<?php echo $AccountNo ?>">
                                                                        <button name="SActivate_btn" type="submit" class="btn btn-success"><i class='bx bx-power-off bx-flip-horizontal'></i> Activate</button>
                                                                    </form>
                                                                </td>
